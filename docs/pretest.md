...
<!-- Bells palsy cause, treatment, prognosis. What is infantile bells palsy?.. -->
...
<!-- staphylococcal scalded skin disease demographics, symptoms, labs, treatment.. -->
...
<!-- Heart conditions to give prophylactic antibiotics.. -->
...
<!-- Human bites result and management.. -->
...
<!-- animal bites management and infection cause.. -->
...
<!-- meningococcal vs HSP symptoms.. -->

HSP also has blood in urine.

## Encopresis

<!-- encopresis is, demographics, retentive vs non retentive, treatment.. -->
...
<!-- genu varum is, demographics, treatment. What is Blount disease, symptoms, labs, treatment.. -->
...
<!-- osgood-schlatter path, pt, symptoms, treatment -->
...
<!-- 2 types of breath holding spells. symptoms, treatment.. -->
...
<!-- cyanide poisoning pt, symptoms, treatment -->
...
<!--  An 8-hour-old infant develops increased respiratory distress, hypothermia, and hypotension. A complete blood count (CBC) demonstrates a white blood cell (WBC) count of 2500/μL with 80% bands. The chest radiograph is shown below. Which of the following is the most likely diagnosis <img src='https://i.imgur.com/BROvf43.png' alt='_' /> ..-->
...
<!-- GBS onset symptoms, labs, treatment.. -->
...
<!-- 2 ways to screen infant for strabismus. Treatment. When to refer to ophthalmologist.. -->
...
<!-- head lice bug, symptoms, treatment.. -->
...
<!-- long lingering meningitis.. -->

- TB lingers for 3 weeks or longer

## Cholesteaoma

<!-- cholesteaomx path, symptoms, treatment.. -->
...
<!-- clonidine child overdose symptoms and treatment.. -->
...
<!-- most common cause of infant seizure, how, treatment.. -->
...
<!-- cold exposure problems and ddx.. -->
...
<!-- trench foot is, cause, symptoms, prognosis -->
...
<!-- frostbite is, cause, symptoms, prognosis -->
...
<!-- Chilblains are, result, compared to frostnip.. -->
...
<!-- cold panniculitis is, cause, symptoms, prognosis -->
...
<!-- phenothiazine symptoms and treatment -->
...
<!-- iron vs lead toxicity treatment .. -->
...
<!-- Isotretinoin teratogenic symptoms -->
...
<!-- prune belly syndrome demographics, symptoms, inheritance -->
...
<!-- Fanconi anemia symptoms, labs, causes.. -->
...
<!-- phimosis normal and abnormal when.. -->
...
<!-- ignore.. -->After her first urinary tract infection, a 1-year-old has a voiding cystourethrogram with findings shown below. Which of the following is the most appropriate treatment option?
...
<!-- acute lobar nephronia is, symptoms, treatment -->
...
<!-- routine BP measurement in children when.. -->
...
<!-- hyptension in children symptoms.. -->
...
<!-- cryptoorchidism risks. Orchiplexi reduce risk for malignancy, sperm count, torsion, epididymitis?.. -->
...
<!-- vulvovaginitis symptoms, cause, treatment.. -->
...
<!-- Vaginal foreign body suspect step.. --> A vaginal examination under general anesthesia is usually required when a vaginal foreign body is suspected. 
...
<!-- Nocturnal enuresis is, gender, normal dry age, primary vs secondary, cause, labs, treatment.. -->
...
<!-- Idiopathic hypercalciuria symptoms -->
...
<!-- Reason for diuretics plus albumin injection in nephrotic syndrome.. -->
...
<!-- Bartter syndrome labs, symptoms, treatment -->
...
<!-- iron vs lead toxicity same and difference.. -->
...
<!-- Transient erythroblastopenia of childhood epidemiology, demographics, symptoms, labs, treatment -->
...
<!-- Diamond-Blackfan anemia demographics, labs, association -->
...
<!-- pearson marrow- pancreas demographics, symptoms -->
...
<!-- Fetomaternal transfusion case and findings, diagnosis.. -->
...
<!-- physiologic anemia of infancy is.. -->
...
<!-- iron deficiency anemia in infants and sickle cell manifest when.. -->
...
<!-- the most common nutritional deficiency in children between 9 and 15 months of age.. -->on-deficiency anemia..
...
<!-- osteosarcoma peds, demographics, symptoms, labs, risks -->
...
<!-- growing pains demographics, symptoms, pathogenesis -->
...
<!-- hodgkin peds, demographics, symptoms, first step, case -->
...
<!-- .<br><img src='https://i.imgur.com/PGyYzAA.png' alt='_' /><br>... -->
...
<!-- .<br><img src='https://i.imgur.com/NiPyyzZ.png' alt='_' /><br>... -->
...
<!-- .<br><img src='https://i.imgur.com/c9MfRLf.png' alt='_' /><br>... -->
...
<!-- .<br><img src='https://i.imgur.com/V0KaSbb.png' alt='_' /><br>... -->
