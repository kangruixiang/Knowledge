...
<!-- Pityriasis rosea symptoms, treatment -->
...
<!-- Seborrheic dermatitis happens when, symptoms --> 
...
<!-- erythema toxicum path, pt, symptoms, treatment -->
...
<!-- pustular melanosis path, pt, symptoms, treatment -->
...
<!-- sebaceous nevi symptoms, location -->
...
<!-- neonatal acne path, pt, treatment -->
